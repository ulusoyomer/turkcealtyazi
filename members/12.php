<?php
                                                ...
                                                $uye_veri_sorgu = $db->query("SELECT * from uyeler WHERE username = 'mustafa'");
                                    ...
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border-bottom:1px solid black; width:5%;">
                                                <?php
                                                                        $izleme_list_sorgu = $db->query("SELECT * FROM izlemeliste WHERE userid = 12 ");
