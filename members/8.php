<?php
                                                ...
                                                $uye_veri_sorgu = $db->query("SELECT * from uyeler WHERE username = 'kral_54'");
                                ...
                                <td style="vertical-align: top; width: 100%;">
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            <td><b>Kayıt</b></td>
                                            <td>:</td>
                                            <td>2019-04-26 00:13:44</td>
                                        </tr>
                                        <tr>
                                            <td><b>Son Giriş</b></td>
                                            <td>:</td>
                                            <td><?php $uye_son_giris; ?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="border-bottom:1px solid black; width:5%;">
                                                <?php
                                                                        $izleme_list_sorgu = $db->query("SELECT * FROM izlemeliste WHERE userid = 8 ");
