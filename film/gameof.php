                ...
                <div id="solgovde">
                    ...
                    <div id="dizi-yorumlari"
                        ...
                        if($sayfa_yorum_yazdirma_kontrol > 0){
                            ...
                            if(@isset($_SESSION["Kullanici"])){ 
                            echo'
                                <a href="gameof.php?sayfa=yorum&like=1"><span class="like-butonu"></span></a> 
                                ';
                            }
                            else{
                                echo'
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <?php
                                if($son_sayfa == 3){
                            ?>
                            <a class="<?php if($sayfa_num == 3){echo "aktifsayfa";} else{echo "sayfalama";} ?>" <?php if($sayfa_num != 2){echo 'href="gameof.php?sayfa=yorum&yorums=3"';} ?>>3</a>
                            <?php
                                }
                            ?>
                        <?php }
