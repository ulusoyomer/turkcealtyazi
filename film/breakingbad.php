            ...
            <div id="zemingovde">
                <div id="solgovde">
                    <div class="sblock">
                        ...
                        <div class="alt-menu">
                            <a href="breakingbad.php?sayfa=dizidetay">Dizi Detay</a>
                            <a>Fragman</a>
                            <a>Görsel</a>
                            <a href="breakingbad.php?sayfa=yorum">Yorum</a>
                            <a>Tavsiye</a>
                            <a>Liste</a>
                            <a>Altyazılar</a>
                        </div>
                        <div class="dizi-detay"
                                        ...
                                        <div class="yıldızlar">
                                            <ul class="yıldızlar-rate">
                                                <li style="margin-left:0px;">
                                                    <a class="yildiz-1" href="breakingbad.php?puan=1">1</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-2" href="breakingbad.php?puan=2">2</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-3" href="breakingbad.php?puan=3">3</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-4" href="breakingbad.php?puan=4">4</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-5" href="breakingbad.php?puan=5">5</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-6" href="breakingbad.php?puan=6">6</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-7" href="breakingbad.php?puan=7">7</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-8" href="breakingbad.php?puan=8">8</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-9" href="breakingbad.php?puan=9">9</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-10" href="breakingbad.php?puan=10">10</a>
                                                </li>
                                            </ul>
                                            <div style="font-size:12px;padding-left:2px;">
                                                <strong>
                            ...
                            <div id="alt-butonlar">
                                ...
                                ?>
                                <a href="breakingbad.php?altsecenek=leklecik">Listemden Çıkar</a>
                                <?php
                                }
                                else{
                                ?>
                                <a href="breakingbad.php?altsecenek=lekle">Listeme Ekle</a>
                                <?php
                                }
                                ?>
                                <a>Altyazı Takibi</a>
                            ...
                            if(isset($_GET["altsecenek"])){
                                if($_GET["altsecenek"] == "lekle"){
                                    ...
                                    header("Location:breakingbad.php");
                                }
                    ...
                    <div id="dizi-yorumlari"
                        ...
                        <div class="sblock comment-block">
                            <form method="POST" action="breakingbad.php">
                                <div class="alt-Baslik">
                                    <h5>
