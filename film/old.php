            ...
            <div id="zemingovde">
                <div id="solgovde">
                    <div class="sblock">
                        ...
                        <div class="alt-menu">
                            <a href="../film/old.php?sayfa=dizidetay">Dizi Detay</a>
                            <a>Fragman</a>
                            <a>Görsel</a>
                            <a href="../film/old.php?sayfa=yorum">Yorum</a>
                            <a>Tavsiye</a>
                            <a>Liste</a>
                            <a>Altyazılar</a>
                        </div>
                        <div class="dizi-detay"
                                        ...
                                        <div class="yıldızlar">
                                            <ul class="yıldızlar-rate">
                                                <li style="margin-left:0px;">
                                                    <a class="yildiz-1" href="../film/old.php?puan=1">1</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-2" href="../film/old.php?puan=2">2</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-3" href="../film/old.php?puan=3">3</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-4" href="../film/old.php?puan=4">4</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-5" href="../film/old.php?puan=5">5</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-6" href="../film/old.php?puan=6">6</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-7" href="../film/old.php?puan=7">7</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-8" href="../film/old.php?puan=8">8</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-9" href="../film/old.php?puan=9">9</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-10" href="../film/old.php?puan=10">10</a>
                                                </li>
                                            </ul>
                                            <div style="font-size:12px;padding-left:2px;">
                                                <strong>
                            ...
                            <div id="alt-butonlar">
                                ...
                                ?>
                                <a href="../film/old.php?altsecenek=leklecik">Listemden Çıkar</a>
                                <?php
                                }
                                else{
                                ?>
                                <a href="../film/old.php?altsecenek=lekle">Listeme Ekle</a>
                                <?php
                                }
                                ?>
                                <a>Altyazı Takibi</a>
                    ...
                    <div id="dizi-yorumlari"
                        ...
                        <div class="sblock comment-block">
                            <form method="POST" action="../film/old.php">
                                <div class="alt-Baslik">
                                    <h5>
                        ...
                        if(isset($_POST["comments"])){
                            ...
                            header("Location:../film/old.php?sayfa=yorum");
                        ...
                        if($sayfa_yorum_yazdirma_kontrol > 0){
                                ...
                                while(@$altyorum_verileri = $altyorumbul_sorgu->fetch_assoc()){
                                    ...
                                    if(@isset($_SESSION["Kullanici"])){ 
                                        ...
                                        if($begeni_sorgu_kontrol > 0){
                                            echo'
                                        <a href="../film/old.php?sayfa=yorum&like2=1&yorum='.$alt_yorum_id.'&yorums='.$sayfa.'"><span class="unlike-butonu"></span></a> 
                                       
                                        ';
                                        }
                                        else{
                                            echo'
                                        <a href="../film/old.php?sayfa=yorum&like2=1&yorum='.$alt_yorum_id.'&yorums='.$sayfa.'"><span class="like-butonu"></span></a>
                                        ';
                                        }
                                    }
                                    else{
                            ...
                            if(@isset($_SESSION["Kullanici"])){ 
                                ...
                                if($begeni_sorgu_kontrol > 0){
                                    echo'
                                <a href="../film/old.php?sayfa=yorum&like=1&yorum='.$yorum_id.'&yorums='.$sayfa.'"><span class="unlike-butonu"></span></a> 
                                ';
                                }
                                else{
                                    echo'
                                <a href="../film/old.php?sayfa=yorum&like=1&yorum='.$yorum_id.'&yorums='.$sayfa.'"><span class="like-butonu"></span></a> 
                                ';
                                }
                            }
                            else{
                            ...
                            <div class="cevapla-alani" style="display:none;" id="alt_yor'.$div_id.'">
                                <form action="../film/old.php" method="POST">
                    ...
                    <div class="sblock page" style="background: none; border: none;">
                        ...
                        ?>
                            <a class="sayfalama"
                                href="../film/old.php?sayfa=yorum&yorums=<?php if($sayfa_num != 1){echo $sayfa_num-1;}  ?>">
                                < Önceki</a> <a
                                    class="<?php if($sayfa_num == 1){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                    <?php if($sayfa_num != 1){echo 'href="../film/old.php?sayfa=yorum&yorums=1"';} ?>>
                                    1
                            </a>
                            <a class="<?php if($sayfa_num == 2){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != 2){echo 'href="../film/old.php?sayfa=yorum&yorums=2"';} ?>>2</a>
                            <a class="sayfalama" href="../film/old.php?sayfa=yorum&yorums=3">3</a>
                            ...
                            <a class="sayfalama"
                                href="../film/old.php?sayfa=yorum&yorums=<?php echo $son_sayfa;  ?>"><?php echo $son_sayfa;  ?></a>
                            <a class="sayfalama"
                                href="../film/old.php?sayfa=yorum&yorums=<?php if($sayfa_num != $son_sayfa){echo $sayfa_num+1;}  ?>">Sonraki
                                ></a>
                           ...
                           ?>
                            <a class="sayfalama"
                                href="../film/old.php?sayfa=yorum&yorums=<?php if($sayfa_num != 1){echo $sayfa_num-1;}  ?>">
                                < Önceki</a> <a class="sayfalama" href="../film/old.php?sayfa=yorum&yorums=1">1
                            </a>
                            ...
                            <a class="<?php if($sayfa_num == $son_sayfa-2){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != $son_sayfa-2){echo 'href="../film/old.php?sayfa=yorum&yorums='.($son_sayfa-2).'"';} ?>><?php echo $son_sayfa-2;  ?></a>
                            <a class="<?php if($sayfa_num == $son_sayfa-1){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != $son_sayfa-1){echo 'href="../film/old.php?sayfa=yorum&yorums='.($son_sayfa-1).'"';} ?>><?php echo $son_sayfa-1;  ?></a>
                            <a class="<?php if($sayfa_num == $son_sayfa){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != $son_sayfa){echo 'href="../film/old.php?sayfa=yorum&yorums='.$son_sayfa.'"';} ?>><?php echo $son_sayfa;  ?></a>
                            <a class="sayfalama"
                                href="../film/old.php?sayfa=yorum&yorums=<?php if($sayfa_num != $son_sayfa){echo $sayfa_num+1;}  ?>">Sonraki
                                ></a>
                            <?php
                           ...
                           ?>
                            ...
                            ...
                            <a class="sayfalama"
                                href="../film/old.php?sayfa=yorum&yorums=<?php echo $sayfa_num-1; ?>"><?php echo $sayfa_num-1;  ?></a>
                        ...
                        ?>
                            ...
                            <a class="<?php if($sayfa_num == 3){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != 3){echo 'href="../film/old.php?sayfa=yorum&yorums=3"';} ?>>3</a>
                            <?php
                                }
                            ?>
                            <?php }
                ...
                <div id="sag-govde">
                    <div class="kisa-sol" id="yorum-poster"
                        style="display:<?php if(@$_GET["sayfa"] == "yorum"){ echo "block";}else{echo "none";} ?>">
                        <a href="../film/old.php" style="margin-top:-4px; margin-bottom: -8px;">
        ...
        if($like == 1){
            ...
            if($like_sorgu_kontrol > 0){
                ...
                $likesi_sorgu = $db->query("UPDATE yorumlar SET begeni=begeni-1 WHERE id = '$yorum_id'");
                 ...
                 header("Location:../film/old.php?sayfa=yorum&yorums=$sayfa");
                }
