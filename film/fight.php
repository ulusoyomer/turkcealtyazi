            ...
            <div id="zemingovde">
                <div id="solgovde">
                    <div class="sblock">
                        ...
                        <div class="alt-menu">
                            <a href="../film/fight.php?sayfa=dizidetay">Dizi Detay</a>
                            <a>Fragman</a>
                            <a>Görsel</a>
                            <a href="../film/fight.php?sayfa=yorum">Yorum</a>
                            <a>Tavsiye</a>
                            <a>Liste</a>
                            <a>Altyazılar</a>
                        </div>
                        <div class="dizi-detay"
                            ...
                            <?php
                                $toplamsonucsorgusu = $db->query("SELECT * FROM yildizoy WHERE isim = 'Fight Club'");
                            ...
                            <div class="dizi-bilgi">
                                <div class="rate">
                                    <div>
                                        ...
                                        <?php
                                        $toplamsonucsorgusu = $db->query("SELECT * FROM yildizoy WHERE isim = 'Fight Club'");
                                        $kisi_sorgusu = $db->query("SELECT * FROM yildizoyatanlar WHERE diziname = 'Fight Club'");
                                        ...
                                        function oylayanlar($db){
                                            $oylayan_sorgu = $db->query("SELECT * FROM yildizoyatanlar WHERE diziname = 'Fight Club' ORDER BY id DESC LIMIT 3");
                                        ...
                                        if(isset($_SESSION["Kullanici"])){
                                            $k_adi = $_SESSION["Kullanici"];
                                            $k_adiSorgusu = $db->query("SELECT * FROM yildizoyatanlar WHERE username ='$k_adi' AND diziname = 'Fight Club'");
                                        ...
                                        <div class="yıldızlar">
                                            <ul class="yıldızlar-rate">
                                                <li style="margin-left:0px;">
                                                    <a class="yildiz-1" href="../film/fight.php?puan=1">1</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-2" href="../film/fight.php?puan=2">2</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-3" href="../film/fight.php?puan=3">3</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-4" href="../film/fight.php?puan=4">4</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-5" href="../film/fight.php?puan=5">5</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-6" href="../film/fight.php?puan=6">6</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-7" href="../film/fight.php?puan=7">7</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-8" href="../film/fight.php?puan=8">8</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-9" href="../film/fight.php?puan=9">9</a>
                                                </li>
                                                <li>
                                                    <a class="yildiz-10" href="../film/fight.php?puan=10">10</a>
                                                </li>
                                            </ul>
                                            <div style="font-size:12px;padding-left:2px;">
                                                <strong>
                            ...
                            ?>
                            <div id="alt-butonlar">
                                <a href="agonder.php?diziname=Fight Club">Altyazı Gönder</a>
                                <?php
                                $k_adi = $_SESSION["Kullanici"];
                                $secenek_sorgu = $db->query("SELECT * FROM izlemeliste WHERE userid = '$uye_id' AND diziadi = 'Fight Club'");
                                $secenek_kontrol = $secenek_sorgu->num_rows;
                                if($secenek_kontrol > 0){
                                ?>
                                <a href="../film/fight.php?altsecenek=leklecik">Listemden Çıkar</a>
                                <?php
                                }
                                else{
                                ?>
                                <a href="../film/fight.php?altsecenek=lekle">Listeme Ekle</a>
                                <?php
                                }
                                ?>
                                <a>Altyazı Takibi</a>
                            ...
                            if(isset($_GET["altsecenek"])){
                                if($_GET["altsecenek"] == "lekle"){
                                    $k_adi = $_SESSION["Kullanici"];
                                    $liste_ekle_sorgu = $db->query("INSERT INTO izlemeliste (diziadi,userid) values ('Fight Club','$uye_id')");
                                    header("Location:../film/fight.php");
                                }
                                elseif($_GET["altsecenek"] == "leklecik"){
                                    $liste_ekle_kaldir_sorgu = $db->query("DELETE from izlemeliste WHERE userid = '$uye_id' AND diziadi = 'Fight Club'");
                                    header("Location:../film/fight.php");
                                }
                                else{
                                    header("Location:../film/fight.php");
                    ...
                    <div id="dizi-yorumlari"
                        ...
                        <div class="sblock comment-block">
                            <form method="POST" action="../film/fight.php">
                                <div class="alt-Baslik">
                                    <h5>
                        ...
                        if(isset($_POST["comments"])){
                            ...
                            $yorumekleme_sorgusu = $db->query("INSERT INTO yorumlar (username,yorum,diziadi,begeni,dizibolum,dizisezon) values('$yorumyapan_adi','$comment','Fight Club',0,'$dizi_bolum',' $dizi_sezon')");
                            $yorum_say_sorgu = $db->query("SELECT * FROM yorumlar WHERE diziadi = 'Fight Club'");
                            $yorum_say_sayfa = $yorum_say_sorgu->num_rows;
                            $son_sayfa = $yorum_say_sayfa / 5;
                            $son_sayfa = ceil($son_sayfa);   
                            header("Location:../film/fight.php?sayfa=yorum");
                        ...
                        $sayfa_yorum_yazdirma_sorgusu = $db->query("SELECT * FROM yorumlar WHERE diziadi='Fight Club' ORDER BY id DESC LIMIT $sayfa,5");
                        $sayfa_yorum_yazdirma_kontrol = $sayfa_yorum_yazdirma_sorgusu->num_rows;
                        $son_sayfa_sorgu = $db->query("SELECT * FROM yorumlar WHERE diziadi='Fight Club'");
                        ...
                        if($sayfa_yorum_yazdirma_kontrol > 0){
                                ...
                                while(@$altyorum_verileri = $altyorumbul_sorgu->fetch_assoc()){
                                    ...
                                    if(@isset($_SESSION["Kullanici"])){ 
                                        ...
                                        if($begeni_sorgu_kontrol > 0){
                                            echo'
                                        <a href="../film/fight.php?sayfa=yorum&like2=1&yorum='.$alt_yorum_id.'&yorums='.$sayfa.'"><span class="unlike-butonu"></span></a> 
                                       
                                        ';
                                        }
                                        else{
                                            echo'
                                        <a href="../film/fight.php?sayfa=yorum&like2=1&yorum='.$alt_yorum_id.'&yorums='.$sayfa.'"><span class="like-butonu"></span></a>
                                        ';
                                        }
                                    }
                                    else{
                            ...
                            if(@isset($_SESSION["Kullanici"])){ 
                                ...
                                if($begeni_sorgu_kontrol > 0){
                                    echo'
                                <a href="../film/fight.php?sayfa=yorum&like=1&yorum='.$yorum_id.'&yorums='.$sayfa.'"><span class="unlike-butonu"></span></a> 
                                ';
                                }
                                else{
                                    echo'
                                <a href="../film/fight.php?sayfa=yorum&like=1&yorum='.$yorum_id.'&yorums='.$sayfa.'"><span class="like-butonu"></span></a> 
                                ';
                                }
                            }
                            else{
                            ...
                            <div class="cevapla-alani" style="display:none;" id="alt_yor'.$div_id.'">
                                <form action="../film/fight.php" method="POST">
                    ...
                    <div class="sblock page" style="background: none; border: none;">
                        ...
                        ?>
                            <a class="sayfalama"
                                href="../film/fight.php?sayfa=yorum&yorums=<?php if($sayfa_num != 1){echo $sayfa_num-1;}  ?>">
                                < Önceki</a> <a
                                    class="<?php if($sayfa_num == 1){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                    <?php if($sayfa_num != 1){echo 'href="../film/fight.php?sayfa=yorum&yorums=1"';} ?>>
                                    1
                            </a>
                            <a class="<?php if($sayfa_num == 2){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != 2){echo 'href="../film/fight.php?sayfa=yorum&yorums=2"';} ?>>2</a>
                            <a class="sayfalama" href="../film/fight.php?sayfa=yorum&yorums=3">3</a>
                            ...
                            <a class="sayfalama"
                                href="../film/fight.php?sayfa=yorum&yorums=<?php echo $son_sayfa;  ?>"><?php echo $son_sayfa;  ?></a>
                            <a class="sayfalama"
                                href="../film/fight.php?sayfa=yorum&yorums=<?php if($sayfa_num != $son_sayfa){echo $sayfa_num+1;}  ?>">Sonraki
                                ></a>
                           ...
                           ?>
                            <a class="sayfalama"
                                href="../film/fight.php?sayfa=yorum&yorums=<?php if($sayfa_num != 1){echo $sayfa_num-1;}  ?>">
                                < Önceki</a> <a class="sayfalama" href="../film/fight.php?sayfa=yorum&yorums=1">1
                            </a>
                            ...
                            <a class="<?php if($sayfa_num == $son_sayfa-2){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != $son_sayfa-2){echo 'href="../film/fight.php?sayfa=yorum&yorums='.($son_sayfa-2).'"';} ?>><?php echo $son_sayfa-2;  ?></a>
                            <a class="<?php if($sayfa_num == $son_sayfa-1){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != $son_sayfa-1){echo 'href="../film/fight.php?sayfa=yorum&yorums='.($son_sayfa-1).'"';} ?>><?php echo $son_sayfa-1;  ?></a>
                            <a class="<?php if($sayfa_num == $son_sayfa){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != $son_sayfa){echo 'href="../film/fight.php?sayfa=yorum&yorums='.$son_sayfa.'"';} ?>><?php echo $son_sayfa;  ?></a>
                            <a class="sayfalama"
                                href="../film/fight.php?sayfa=yorum&yorums=<?php if($sayfa_num != $son_sayfa){echo $sayfa_num+1;}  ?>">Sonraki
                                ></a>
                            <?php
                           ...
                           ?>
                            ...
                            ...
                            <a class="sayfalama"
                                href="../film/fight.php?sayfa=yorum&yorums=<?php echo $sayfa_num-1; ?>"><?php echo $sayfa_num-1;  ?></a>
                        ...
                        ?>
                            ...
                            <a class="<?php if($sayfa_num == 3){echo "aktifsayfa";} else{echo "sayfalama";} ?>"
                                <?php if($sayfa_num != 3){echo 'href="../film/fight.php?sayfa=yorum&yorums=3"';} ?>>3</a>
                            <?php
                                }
                            ?>
                            <?php }
                    ...
                    <?php
                        ...
                        $subs_sorgu = $db->query("SELECT * FROM subs WHERE diziname='Fight Club' AND onay = '1' ");
                        $subs_sorgu_kontrol = $subs_sorgu->num_rows;
                        $sezonlar = array();
                        if($subs_sorgu_kontrol > 0){
                            $sezon_kontrol = $db->query("SELECT DISTINCT sezon FROM subs WHERE diziname='Fight Club' AND onay = '1' ORDER BY sezon DESC");
                            while($deger = $sezon_kontrol->fetch_assoc()){
                                array_push($sezonlar,$deger["sezon"]);
                            }
                            for($i = 0 ;$i<count($sezonlar);$i++){
                                $s = $sezonlar[$i];
                                $altyazı_bul = $db->query("SELECT * FROM subs WHERE sezon = '$s' AND onay = 1 AND diziname='Fight Club' ORDER BY bolum ");
                                ?>
                ...
                <div id="sag-govde">
                    <div class="kisa-sol" id="yorum-poster"
                        style="display:<?php if(@$_GET["sayfa"] == "yorum"){ echo "block";}else{echo "none";} ?>">
                        <a href="../film/fight.php" style="margin-top:-4px; margin-bottom: -8px;">
                            <img src="../film/filmPoster/fightyorum.jpg" width="308" height="173" style="border-radius:4px;"
                                title="Fight Club" alt="Fight Club">
                        </a>
                    </div>
                    <div class="kisa-sol">
...
if(isset($_GET["puan"])){
    ...
    if(($puan == 1) || ($puan == 2) || ($puan == 3) || ($puan == 4) || ($puan == 5) || ($puan == 6) || ($puan == 7) || ($puan == 8) || ($puan == 9) || ($puan == 10)){
        $k_adi = $_SESSION["Kullanici"];
        $k_adiKayit = $db->query("INSERT INTO yildizoyatanlar (username,puan,diziname) values ('$k_adi','$puan','Fight Club')");
        $puan_Kayit = $db->query("UPDATE yildizoy set oy = oy + '$puan',toplam = toplam + 1 WHERE isim = 'Fight Club'");
        if($puan_Kayit){
            echo "hata";
        }
        header("Location:../film/fight.php");
        ...
        if($like == 1){
            ...
            if($like_sorgu_kontrol > 0){
                ...
                $likesi_sorgu = $db->query("UPDATE yorumlar SET begeni=begeni-1 WHERE id = '$yorum_id'");
                 ...
                 header("Location:../film/fight.php?sayfa=yorum&yorums=$sayfa");
                }
